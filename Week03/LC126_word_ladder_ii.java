...
import Week04.LC127_word_ladder;
...
public class LC126_word_ladder_ii {
    ...
    static class Solution {
        ...
        private ArrayList<String> getNeighbors(String w, Set<String> wordSet) {
    ...
    public static void main(String[] args) {
        ...
        LC126_word_ladder_ii.Solution solution = new LC126_word_ladder_ii.Solution();
